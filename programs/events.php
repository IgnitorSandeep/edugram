        ...
        <div class="container">  
			...
			<div class="row">
				<div class="col-md-7">
					...
					<p class="lead" align="justify">Edugram has successfully organized a innovative apptitude test
					  and Multiple Intelligence Test in a small village i.e. Naikachhapara and Amarpur
			...
			<div class="row">
				...
				<div class="col-md-7">
				  ...
				  <p class="lead"  align="justify">Each students has a unique talent.
			...
			<div class="row featurette">
				<div class="col-md-7">
				  ...
				  <p class="lead"  align="justify">We all experience problem throughout the life but sometimes we get it solve very easily.
