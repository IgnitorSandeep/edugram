<div id="carousel-example-generic" class="carousel slide">
	 ...
	 <div class="item active">
	    <img src="image/theme/shirt_900x500.jpg" class="img-responsive" alt="...">
	    <div class="carousel-caption">
	      <h1>Edugram T'Shirt</h1>
	    </div>
	  </div>
	  <div class="item">
	    <img src="image/theme/talent_900x500.jpg" class="img-responsive" alt="...">
	    <div class="carousel-caption">
	      <h1>Honouring Talent</h1>
	    </div>
	  </div>
	  <div class="item">
	      <img src="image/theme/team_900x500.jpg" class="img-responsive" alt="...">
	      <div class="carousel-caption">
		<h1>Our Team</h1>
	      </div>
	  </div>
...
<div class="container">
	<div class="row">
	 <div class="col-lg-4">
	  ...
	  <div class="col-lg-4">
	    <h2>Events</h2>
	    <p>EduGram organizes <a href="event_2013.html">"Talent Search Test"</a> every year to interact with students and promote their talents with some awards. Events are like :</p>
	    <ul>
